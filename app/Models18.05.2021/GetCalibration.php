...
class GetCalibration extends Model
{
	...
	protected $fillable=['CalibrationId','WeightBoxId','CalibrationName','InstrumentId','InstrumentName','DeviceId','DeviceName','DeviceType','Make','Model','SpiritLevel','Internal','CalibrationDate','CalibrationNextDate','PerformedBy','PerformDate','VerifiedBy','VerifiedDate','AproovelBy','AproovelDate','Status','FormId','RePerform'];
