...
class GetCalibrationLine extends Model
{
	...
	protected $fillable=['RefRecId','CalibrationTypeId','Type','StWeight','CertWeight','DispWeight','DiffWeight','AccpWeight','Result','Tfile','Ifile','CreatedBy'];
	...
	// public function DeleteCalibrationLine($data)
	// {
