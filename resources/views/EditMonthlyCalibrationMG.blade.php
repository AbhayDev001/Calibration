							...
							<div class="row">
                                ...
                                <fieldset class="col-lg-6 mt10 mobile-mt20">
									<div class="row">
										...
										<div class="col-md-8 input-area">
											<i class="icon-append fa fa-calendar"></i>
											<input type="text" class="form-input form-control NextCalibratedDate" name="NextCalibratedDate" readonly="readonly" value="{{ date('d-m-Y',strtotime($caldata->CalibrationNextDate)) }}">
										</div>
									</div>
								</fieldset>
							</div>
									...
									<tbody>
										<tr>
											<th class="text-center" style="width: 50%;">
												<p>2 X SD X 100</p>
												<p style="border-top: 1px dotted #111;">Desired smallest net weight(mg)</p>
											</th>
											<td class="text-center" colspan="2">
												<p>2 X <span class="StandardMassText">0</span> X 100</p>
												<p style="border-top: 1px dotted #111;">{{$caldata->Desired_Smallest}}</p>
											</td>
										</tr>
										<tr>
...
function GetAvg(){
	...
	var DefaultSD = 0.41*0.00001;
	if(SDMass2 < DefaultSD){
		SDMass2 = DefaultSD;
	}
	$(".StandardMass").val(SDMass.toFixed(8));
	$(".StandardMassText").text(SDMass2);
	var Desired_Smallest=Number("<?php echo $caldata->Desired_Smallest; ?>");
	var RealSD=(2*SDMass2*100)/Desired_Smallest;
	// end rhl 14-12-2020 //
