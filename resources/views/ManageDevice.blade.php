						...
						<div class="modal-body">
							...
							<div class="input-area">
								<div class="form-group">
									...
									<select type="text" class="form-control UpdInstrumentId" name="InstrumentId" required>
							...
							<div class="input-area">
								<div class="form-group">
									<label for="Master_Calibration_Date">Master Calibration Date</label>
									<select class="form-input form-control UpdMaster_Calibration_Date" name="Master_Calibration_Date" required>
...
<script type="text/javascript">
	...
	$(".btnUpdForm").click(function(){
		...
		if($(".UpdMaster_Calibration_Date").val()=='')
		{
			$(".UpdMaster_Calibration_Date").parent("div").children(".tooltip").remove();
			$(".UpdMaster_Calibration_Date").parent("div").append("<b class='tooltip tooltip-bottom-right' style='opacity:1;'>Required field</b>",removetooltip('UpdMaster_Calibration_Date'));
			$(".UpdMaster_Calibration_Date").focus();
			return false;
		}
	});
</script>
	...
	$(".btnEditForm").click(function(){
		$.get('../AjaxGetDevice1/'+ $(this).attr("data-RecId"),function(data){
			if(data!='')
			{
				...
				$(".UpdMaster_Calibration_Date").val(data['Master_Calibration_Date']);
