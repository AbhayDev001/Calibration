		...
		<div class="row">
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="product-content product-wrap clearfix product-deatil">
					<form id="SaveUser" name="frm" method="post" action="{{ url('SaveWeightBox') }}">
								...
								<fieldset class="col-lg-6 mobile-mt20">
									<div class="row">
										...
										<div class="col-md-7 input-area">
											...
											<input type="text" name="WeightBoxId" class="form-input form-control WeightBoxId" autocomplete="off">
										</div>
									</div>
								</fieldset>
								<fieldset class="col-lg-6 mobile-mt20">
									<div class="row">
										...
										<div class="col-md-7 input-area">
											...
											<input type="datetime-local" class="form-input form-control WeightBox_calibration_on" name="WeightBox_calibration_on">
										</div> 
									</div>
								</fieldset>
							</div>
								...
								<fieldset class="col-lg-6 mobile-mt20">
									<div class="row">
										...
										<div class="col-md-7 input-area">
											...
											<input type="datetime-local" class="form-input form-control WeightBox_next_calibration" name="WeightBox_next_calibration" >
										</div> 
									</div>
								</fieldset>
							</div>
