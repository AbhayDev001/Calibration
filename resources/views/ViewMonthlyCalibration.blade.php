                        ...
                        <div class="row">
                            <fieldset class="col-lg-6 mt10 mobile-mt20">
								<div class="row">
									...
									<div class="col-md-8 input-area">
										<i class="icon-append fa fa-calendar"></i>
										<input type="text" class="form-input form-control NextCalibratedDate1" name="NextCalibratedDate1" value="{{ date('d-m-Y',strtotime($caldata->CalibrationNextDate1)) }}" readonly="readonly">
									</div>
								</div>
							</fieldset>
						</div>
						...
						<div class="row">
							...
							<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 mt10">
								...
								<div class="inline-group RdoYesNo" style="pointer-events: none;margin-top: 7px;">
									<label class="radiobtn">
										<input type="radio" class="RdoYes" name="CompliesAcceptanceCriteria2" value="1"  value="1" <?php if($caldata1->CompliesAcceptanceCriteria2==1) { ?> checked="checked" <?php } ?>>
										<i></i>Yes
									</label>
									<label class="radiobtn">
										<input type="radio" class="RdoNo" name="CompliesAcceptanceCriteria2" value="2" value="1" <?php if($caldata1->CompliesAcceptanceCriteria2==2) { ?> checked="checked" <?php } ?>>
										<i></i>No
									</label>
								</div>
							</div>
