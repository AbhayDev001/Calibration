					...
					<div class="col-lg-12">
						<div class="row top-menu-box">
								<?php /*<ul class="top-box-menu-bar">
									...
									<?php /*<div id="TimeLeft" class="pull-right ml10" style="font-weight: bold;color: #0090d5;">Auto Save : 45 : 00</div> */ ?>
							...
							<form id="SaveCalibration" name="frm" method="post" action="{{ url('SaveCalibration') }}">
									...
									<div class="col-lg-12 mtb20">
										<div class="row">
											<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
												<div id="TimeLeft" class="ml10" style="font-weight: bold;color: #0090d5;">Auto Save : 45 : 00</div>
											</div>
											<div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
							...
							$.get('CheckAvailableCalibration/'+ JSON.stringify(obj),function(data){
								...
								else
								{
									...
									$.get('AjaxGetDeviceValue/'+ JSON.stringify(obj),function(data){
										...
										//$('.NextCalibratedDate').val(data['firstdata']['DayAdd']);
			...
			$('#ShowFile').modal('show');
					...
					$(".btnSaveFormData").click(function(){
						...
						if (checkedUserType.length == 0) {
							...
							$(".BalanceChecked").parent("div").append("<b class='tooltip tooltip-bottom-right' style='opacity:1;right:50%;'>Required field</b>", removetooltip('BalanceChecked'));
						...
						if (checkedUserType.length == 0) {
							...
							$(".InternalCalibration").parent("div").append("<b class='tooltip tooltip-bottom-right' style='opacity:1;right:50%;'>Required field</b>", removetooltip('InternalCalibration'));
...
<script type="text/javascript">
	...
	var x = setInterval(function() {
		...
		if (distance < 0) {
			...
			if($(".CalibrationMethod").val()=='' || $(".CalibrationMethod").val()==0 || $(".InstrumentID").val()=='' || $(".InstrumentID").val()==0 || $(".DeviceType").val()=='' || $(".DeviceType").val()==0 || checkedUserType.length == 0 || checkedUserType1.length == 0)
			{
