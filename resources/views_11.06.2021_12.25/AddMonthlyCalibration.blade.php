					...
					<div class="col-lg-12">
						<div class="row top-menu-box">
							...
							<form id="SaveCalibration" name="frm" method="post" action="{{ url('SaveMonthlyCalibration') }}">
								...
								@php
														$MonthlyDisplayValue=DB::table('formula_setting')->get();
														@endphp
								<input type="hidden" readonly="readonly" name="Desired_Smallest" value="{{ $MonthlyDisplayValue[0]->MonthlyDisplayValue }}" class="form-input form-control Desired_Smallest">
