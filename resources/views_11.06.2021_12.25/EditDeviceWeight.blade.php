						...
						<div class="col-lg-12">
								...
								<table class="table table-striped table-bordered table-hover DeviceWeightData2" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" class="ActualMass numeric1 form-control" name="ActualMass[]" value="{{ $data->ActualMass }}" style="width:100%;">
											</td>
											<td>
												@if($key<1)
							...
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover DeviceWeightData3" width="100%">
									...
									<tbody>
										@foreach($MainData['CalibrationLine'] as  $key=>$data)
										<tr>
											<td>
												<input type="text" class="LLineId numeric1 TabInput" name="LLineId[]" value="{{ $data->LineId }}" readonly="readonly" />
											</td>
											<td>
												<input type="text" class="LStWeight numeric1 form-control" name="LStWeight[]" value="{{ $data->StWeight }}" style="width:100%;"/>
											</td>
											<td>
												<input type="text" class="LCertWeight numeric1 form-control" name="LCertWeight[]" value="{{ $data->CertWeight }}" style="width:100%;"/>
											</td>
											<td>
												<input type="text" class="LAccpWeight numeric1 form-control" name="LAccpWeight[]" value="{{ $data->AccpWeight }}" style="width:100%;"/>
											</td>
											<td>
												@if($key<1)

												@else
												<a href='javascript:void(0)' class='btn btn-xs btn-default btnDeleteRow3'><i class='fa fa-trash'></i></a>
												@endif
											</td>
										</tr>
										@endforeach
