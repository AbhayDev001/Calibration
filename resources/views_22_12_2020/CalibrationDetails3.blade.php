						...
						<div class="col-lg-12 pdtrb-15">
							...
							<div class="row">
								<fieldset class="col-lg-6 mt10 mobile-mt20">
									<div class="row">
										<label class="col-md-3 control-label form-lable"><b>Make:</b></label>
										<div class="col-md-9 input-area">
							...
							<div class="row">
								...
								<fieldset class="col-lg-6 mt10 mobile-mt20">
									<div class="row">
										<label class="col-md-3 control-label form-lable"><b>Model:</b></label>
										<div class="col-md-9 input-area">
											<i class="icon-append fa fa-user"></i>
