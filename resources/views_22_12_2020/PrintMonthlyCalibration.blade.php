...
<body>
	...
	<table class="table table-bordered tablefontsize mt10 mb20">
		...
		<tbody>
			...
			<tr>
				...
				<td>{{ number_format((float)$val->AccpWeight, $MainData['Decimal'][0]->acceptance_weight, '.', '') }}</td>
	...
	<table class="mytable">
		...
		<tr>
			<td>Next Calibration on </td>
			<td>: <span class="UnderLine">{{ date('d/m/Y h:i A',strtotime($caldata->CalibrationNextDate1)) }}</span></td>
		</tr>
	</table>
