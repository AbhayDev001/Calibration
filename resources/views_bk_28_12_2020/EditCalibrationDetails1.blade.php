								...
								<table class="table table-striped table-bordered table-hover" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<input type='text' class='ActualMass TabInput numeric1' readonly="readonly" autocomplete="off" style="width: 100%;" name='ActualMass[]' value="{{ number_format((float)$val->AccpWeight, $MainData['Decimal'][0]->acceptance_weight, '.', '') }}" />
											</td>
											<td>
