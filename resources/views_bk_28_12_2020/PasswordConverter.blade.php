...
<head>
    <meta charset="utf-8">
    <title>Calibration - Secure Key Converter</title>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 login-form-data">
                    ...
                    <div class="well no-padding smart-form client-form">
                        ...
                        <header style="text-align: center;"><b>Password to Secure Key Converter</b></header>
                        <form name="frm" method="post" action="{{ url('ConvertSecureKey') }}">
