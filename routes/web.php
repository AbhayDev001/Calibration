...
Route::get('/ManageFormulaSettings', 'AdminController@ManageFormulaSettings');
Route::post('/SaveFormulaSettings', 'AdminController@SaveFormulaSettings');
Route::get('/SaveFormulaSettings', function () {
	return redirect('/');
});
...
// Route::get('/RestoreDatabase/{full_path}', 'BackupController@RestoreDatabase');
